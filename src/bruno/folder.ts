...
export function generateFolderBru(folder: BruFolderFile): string {
...
export function parseFolderBru(content: string): BruFolderFile {
...
export async function readFolderDocs(folderPath: string): Promise<string | undefined> {
  try {
...
export async function writeFolderDocs(folderPath: string, folderName: string, docs: string): Promise<string> {
