 ...
 */
import { BruValidationError } from './types.js';
export class BruGenerator {
     ...
     */
    generatePreRequestScript(script) {
     ...
     */
    generatePostResponseScript(script) {
 ...
 */
export function generateBruFile(bruFile, options) {
 ...
 */
export function createBasicBruFile(name, method, url, sequence) {
    return {
        meta: {
            name,
            type: 'http',
