...
function folderOf(collectionPath, requestPath) {
    const relativeDir = join(requestPath, '..').slice(collectionPath.length).replace(/^[\\/]/, '');
    return relativeDir || '(root)';
}
export async function generateDocsSite(collectionManager, options) {
    try {
...
function renderSite(collectionName, collectionDocsHtml, entries) {
...
//# sourceMappingURL=docsSite.js.map